...
select max(domain_id)+1 domain_id
     , '" . mysqli_real_escape_string($db, $username) . "'      username     
     , '" . mysqli_real_escape_string($db, $encrypted_pw) . "'  md5_pass
     , '" . mysqli_real_escape_string($db, $lastname) . "'      lastname
     , '" . mysqli_real_escape_string($db, $firstname) . "'     firstname
     , '" . mysqli_real_escape_string($db, $email) . "'         email
     , '" . mysqli_real_escape_string($db, $phone) . "'         phone  
     , '" . mysqli_real_escape_string($db, $password_hint) . "' password_hint from " . $usertable . ";";
