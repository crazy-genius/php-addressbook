<?php
    include_once __DIR__ . DIRECTORY_SEPARATOR . 'version.inc.php';
?>
    ...
    <br>
        ...
        <div id="footer">
            <ul>
                <li>
                    <a href="http://sourceforge.net/projects/php-addressbook/">php-addressbook</a>
                    <a href="notes.htm">v<?php echo $version; ?></a>
                </li>
            </ul>
        </div>
    </div>
