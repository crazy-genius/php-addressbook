...
$base_url = "https://maps.google.com/maps?output=csv&key=" . $google_maps_key;
$first_fetch = true;
...
?>
<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=true&amp;key=<? echo $google_maps_key; ?>"
    ...
    function initialize() {
        if (GBrowserIsCompatible()) {
            ...
            GEvent.addListener(marker<?php echo $i; ?>, "mouseover"
                , function () {
                    marker<?php echo $i; ?>.openInfoWindowHtml(<?php echo '"' . $coord['bubble'] . '"'?>);
                });
