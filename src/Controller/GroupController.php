...
use AddressBook\Form\GroupType;
...
class GroupController extends AbstractController
{
    ...
    #[Route('/{domainId}', name: 'app_group_show', methods: ['GET'])]
    ...
    #[Route('/{domainId}/edit', name: 'app_group_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{domainId}', name: 'app_group_delete', methods: ['POST'])]
    public function delete(Request $request, Group $group, GroupRepository $groupRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$group->getDomainId(), $request->request->get('_token'))) {
