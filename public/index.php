<?php
require_once '..' . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'bootstrap.php';
...
<div id="search-az">
    <?php if (!$use_ajax) { ?>
        <form accept-charset="utf-8" method="get" name="searchform">
            <input type="text" value="<?php echo $searchstring; ?>" name="searchstring"
                   title="<?php echo ucfmsg('SEARCH_FOR_ANY_TEXT'); ?>" size="45" tabindex="0"/>
